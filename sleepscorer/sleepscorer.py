    ...
    def download_weights(self, cnn = True, rnn = True, ask=False):
        ...
        if cnn:
            ...
            if r.upper() == 'Y':
                ...
                tools.download('https://drive.skjerns.de/index.php/s/CHKFgQkcfYCGxg2/download/cnn.hdf5', './weights/cnn.hdf5')
        ...
        if rnn:
            ...
            if r.upper() == 'Y':
                ...
                tools.download('https://drive.skjerns.de/index.php/s/gMoaEerJyDSEz28/download/rnn.hdf5', './weights/rnn.hdf5')
...
class Classifier(object):
    ...
    def download_weights(self):
        ...
        tools.download('https://cloud.skjerns.de/index.php/s/gioYQWEFCKYgL3Z/download/cnn.hdf5', './weights/cnn.hdf5')
        tools.download('https://cloud.skjerns.de/index.php/s/fxCxemRXA5D3Acr/download/rnn.hdf5', './weights/rnn.hdf5')
